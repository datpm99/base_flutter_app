...
import 'package:flutter_cupertino_datetime_picker/src/date_picker_theme.dart';
import 'package:flutter_cupertino_datetime_picker/src/date_time_formatter.dart';
import 'package:flutter_cupertino_datetime_picker/src/i18n/date_picker_i18n.dart';
import 'package:flutter_cupertino_datetime_picker/src/widget/date_picker_title_widget.dart';
import 'package:flutter_cupertino_datetime_picker/src/widget/date_picker_widget.dart';

/// DateTimePicker widget. Can display date and time picker.
class AppDateTimePickerWidget extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _AppDateTimePickerWidgetState(
      minDateTime, maxDateTime, initDateTime, minuteDivider);
}

class _AppDateTimePickerWidgetState extends State<AppDateTimePickerWidget> {
  ...
  bool _isProgrammaticMinuteChange = false;

  _AppDateTimePickerWidgetState(DateTime? minTime, DateTime? maxTime,
  ...
  void _changeMinuteSelection(int index) {
    if (_isProgrammaticMinuteChange) {
      _isProgrammaticMinuteChange = false;
      return;
    }
  ...
  void _changeTimeRange() {
    ...
    if (minuteRangeChanged) {
      ...
      _isProgrammaticMinuteChange = true;
      _minuteScrollCtrl
